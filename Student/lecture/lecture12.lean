...
-- YOU DO THE REST 
-- Not One or Not the Other Implies Not Both
...
def newInterp : Interp :=
 fun var => match var.n with 
| 0 => true
| 1 => false
| 2 => true
| 3 => false
...
#eval eval_expr e0 (newInterp) -- Expect true
#eval eval_expr e1 (newInterp) -- Expect true
#eval eval_expr e2 (newInterp) -- Expect true
#eval eval_expr e3 (newInterp) -- Expect true
